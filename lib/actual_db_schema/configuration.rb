...
module ActualDbSchema
  ...
  class Configuration
    attr_accessor :enabled, :auto_rollback_disabled, :ui_enabled, :git_hooks_enabled, :multi_tenant_schemas,
                  :console_migrations_enabled, :migrated_folder, :ui_namespace
    ...
    def initialize
      ...
      @migrated_folder = ENV["ACTUAL_DB_SCHEMA_MIGRATED_FOLDER"].presence
      @ui_namespace = ENV["ACTUAL_DB_SCHEMA_UI_NAMESPACE"].presence || "migrations"
    end
